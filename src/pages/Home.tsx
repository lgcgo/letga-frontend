...
const Home: React.FC = () => {
  return (
    <GridContent contentWidth="Fixed">
      <Row gutter={[24, 24]}>
        <Col span={24}>
          <ProCard style={{ backgroundColor: '#1890ff' }}>
            <br />
            <Title style={{ color: '#ffffff' }} level={4}>
              欢迎使用Letga !
            </Title>
            <Text style={{ color: '#ffffff' }}>
              Letga 是基于 GoFrame + AntDesign
              的中后台管理系统，系统集成了通用的中后台基础功能模块，是一款高性能、易扩展、高颜值的企业级开源系统。
            </Text>
            <br />
            <Text style={{ color: '#ffffff' }}>
              在使用中遇到问题，可以查看「使用帮助」，或者在「Letga社区」寻求帮助
            </Text>
            <br />
            <br />
          </ProCard>
          ...
          <ProCard gutter={8} direction="column" split="horizontal">
            ...
            <StatisticCard
              statistic={{
                title: '近7天请求',
                value: 234,
                description: <Statistic title="较近月平均" value="8.04%" trend="up" />,
              }}
            />
            <StatisticCard
              statistic={{
                title: '本月请求数',
                value: 234,
                description: <Statistic title="较上月平均" value="8.04%" trend="up" />,
              }}
            />
          </ProCard>
        </Col>
        <Col span={16}>
          <ProCard title="流量统计 - demo" headerBordered>
            <DemoLine />
          </ProCard>
        </Col>
        <Col span={24}>
        ...
        <Col span={16}>
          <ProCard title="用户分布 - demo" headerBordered>
            <div style={{ width: '100%', height: 400, textAlign: 'center' }}>
              <Image src="/map_china.png" height={400} />
            </div>
          </ProCard>
        </Col>
        <Col span={24}>
